				...
				<div class="col-lg-7 order-2 order-lg-1">
					<?php form_open('log_in/forget_password'); ?>
						<form class="contact-form" action="" method="post">
							...
							<input type="text" name="email" id="email" placeholder="Your e-mail" value="<?php echo $email; ?>" autocomplete="off">
							<input type="password" name="password" id="password" placeholder="New password" autofocus="" autocomplete="off">
